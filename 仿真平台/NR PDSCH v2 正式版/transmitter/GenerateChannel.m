...
elseif strcmp(channel.Type,'CDL-C-CAICT')
    H = GenerateCDL_C_CAICT(BlockInd,channel);
elseif strcmp(channel.Type,'CDL-D-CAICT')
    H = GenerateCDL_D_CAICT(BlockInd,channel);
else
