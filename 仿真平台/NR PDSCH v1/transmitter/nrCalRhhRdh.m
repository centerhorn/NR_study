...
%% Output
%  Rhh          : 3-Dimensional array ((number of DMRS RE)-(number of DMRS RE)-rank)
...
function [Rhh,Rdh] = nrCalRhhRdh(DMRS_LOCATION,DATA_LOCATION,channel)
