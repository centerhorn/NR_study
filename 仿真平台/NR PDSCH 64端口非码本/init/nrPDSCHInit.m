...
pdschConfig.PdschSymbolsLocation = 1:13;         % PDSCH symbol locations within a slot
pdschConfig.PdcchSymbolsLocation = 0;          % PDCCH (CORESET) symbol locations within a slot
...
%Codebook
pdschConfig.CodebookBased = 0; %基于非码本
pdschConfig.CodebookSelectPrinciple = 2;
pdschConfig.PortCSIRS = gnbConfig.MTxRu*gnbConfig.NTxRu*gnbConfig.PolarNum;
...
%     ON12 = zeros(1,4);
% end
if  pdschConfig.CodebookBased == 1
...
pdschConfig.EnableRbBundleInterleave = false;
